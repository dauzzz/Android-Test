...
public class Decoder extends Thread {
    ...
    public final BlockingQueue<ByteBuffer> sharedQ;
    private Surface decodedSurface;

    private int in = 0;

    protected Decoder(BlockingQueue<ByteBuffer> sharedQ, Surface decodedSurface) {
        ...
        while (!Thread.interrupted()){
            ...
            if(inputBufferId >= 0){
                ...
                try {
                    ...
                    inputBuffer.put((ByteBuffer) sharedQ.take());
